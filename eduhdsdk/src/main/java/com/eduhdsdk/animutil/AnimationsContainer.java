...
public class AnimationsContainer {
    ...
    public AnimationsContainer(int[] frames, int fps, Context context) {
        mContext = context;
        this.mFrames = frames;
    }
...
//    private int[] mProgressAnimFrames = getData(resId);
    ...
    public FramesSequenceAnimation createProgressDialogAnim(ImageView imageView) {
        return new FramesSequenceAnimation(imageView, FPS);
    }
    ...
    public class FramesSequenceAnimation {
        ...
        public FramesSequenceAnimation(ImageView imageView, int fps) {
    ...
    private int[] getData(int resId) {
        ...
        for (int i = 0; i < len; i++) {
            intArray[i] = array.getResourceId(i, -1);
        }
        array.recycle();
        return intArray;
    }
