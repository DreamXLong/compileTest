...
public class ServerListAdapter extends BaseAdapter {
    ...
    public ServerListAdapter(Context mContext) {
        ...
        TKRoomManager.getInstance().requestServerList(RoomClient.webServer, new RequestServerListCallback() {
            @Override
    ...
    public void setSelectPostion(int selectPostion) {
        if (services.get(selectPostion) != null) {
            TKRoomManager.getInstance().changeDefaultServer(services.get(selectPostion).getServiceName());
        }
